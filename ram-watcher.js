...
const HOST         = flag('--local') ? '127.0.0.1' : arg('--host', '192.168.68.73');    //Edit as required
const PORT         = parseInt(arg('--port', '55355'));
const OLLAMA_URL   = flag('--local') ? '127.0.0.1' : arg('--ollama', 'http://192.168.68.88:11434');      //Edit as required
const MODEL        = arg('--model', 'qwen2.5:14b');      //Edit as required
